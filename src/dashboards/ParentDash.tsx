...
import { BookOpen, Users, MessageSquare, Menu, X, Edit2Icon, User } from "lucide-react";
      ...
      {activeTab === "profile" && (
        ...
        {activeTab === "awareness" && (
          <section className="text-justify dark:text-dark-text">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Education is vital for your child's future. Here are some key points to consider:
            </p>
            <div className="mt-4">
              <h2 className="text-lg font-semibold">Frequently Asked Questions</h2>
              <div className="border border-gray-300 rounded mt-2">
                {["Why is education important for girls?", "How can I support my daughter's education?", "What are the benefits of education?"].map((question, index) => (
                  <div key={index} className="p-2 cursor-pointer" onClick={() => setFaqOpen(faqOpen === index ? null : index)}>
                    <h3 className="font-medium">{question}</h3>
                    {faqOpen === index && (
                      <p className="mt-1 text-gray-500 dark:text-gray-300">
                        {index === 0 && "Education empowers girls, providing them with knowledge and skills to improve their lives and communities."}
                        {index === 1 && "Encourage her to pursue her studies, provide resources, and engage with her teachers."}
                        {index === 2 && "Education leads to better job opportunities, improved health, and greater social equality."}
                      </p>
                    )}
                  </div>
                ))}
        ...
        {activeTab === "parenting" && (
          <section className="text-justify dark:text-dark-text">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              As a parent, your support is crucial. Here are some tips to help you:
            </p>
            <ul className="list-disc list-inside mt-2">
              <li>Encourage open communication with your child.</li>
              <li>Be involved in their education and school activities.</li>
              <li>Teach them about the importance of education and self-worth.</li>
              <li>Provide a supportive and nurturing environment at home.</li>
            </ul>
          </section>
        )}
        {activeTab === "community" && (
          <section className="text-justify dark:text-dark-text">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              ...
              <Link to="/community" className="text-light-primary underline"> Click here to join the community.</Link>
            </p>
          </section>
        )}
