...
const LearnerDashboard = () => {
  ...
  const { courses, progress: courseProgressMap } = useSelector(
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      const myLikedTopics = topics.filter((topic) =>
        topic.likes.some(
          (like: { userId: any }) => like.userId === currentUser.id
        )
      );
  ...
  return (
    <div className="flex min-h-screen bg-light-background dark:bg-dark-background">
      ...
      <main className="flex-1 p-6">
          ...
          <section className="w-full max-w-5xl mx-auto mt-12 dark:text-dark-text">
            ...
            {filteredCourses.length > 0 ? (
              ...
              <p className="text-gray-600 dark:text-gray-300 text-center">
                No courses with progress found.
              </p>
            )}
          </section>
        )}
        ...
        {activeTab === "community" && (
          <section className="w-full max-w-5xl mx-auto mt-12 dark:text-dark-text">
            <h1 className="text-2xl font-bold mb-6 text-center text-light-secondary">
              Liked on Community Page
            </h1>
